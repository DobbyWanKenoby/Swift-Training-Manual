 ...
 * Для очищения autorelease pool вызывает его метод drain.
 * Autoreleasepool автоматически создается в начале RunLoop и удаляется в конце иттерации. При этом вызывается drain.

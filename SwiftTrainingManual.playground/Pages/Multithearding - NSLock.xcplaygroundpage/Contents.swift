/*:
 ...
 ### Описание
 * Позволяет заблокировать выполнение потока для обеспечения персонального доступа к данным. Пока поток работает с данными, никто другой работать с ними не может.
